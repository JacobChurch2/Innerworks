...
namespace NavMeshPlus.Extensions
{
    ...
    class NavMeshBuilder2d
    {
        ...
        {
			CompositeCollider2D compositeCollider = collider.attachedRigidbody?.GetComponent<CompositeCollider2D>();

			if (compositeCollider != null)
			{
				// If the collider is part of a composite, use the composite instead
